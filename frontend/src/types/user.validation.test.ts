...
describe('User Type Validation - Small Tests', () => {
  it('[Small] UserCodec validates complete user data', () => {
    const validUser = {
      id: 1,
  ...
  it('[Small] UserCodec rejects user with invalid ID type', () => {
    const invalidUser = {
      id: 'not-a-number',
      email: 'test@example.com',
      name: 'Test User',
  ...
  it('[Small] UserCodec rejects user with missing required fields', () => {
    const invalidUser = {
      id: 1,
      email: 'test@example.com',
      // missing name
  ...
  it('[Small] CreateUserCodec validates valid user data', () => {
    const validUser = {
      email: 'test@example.com',
      name: 'Test User',
    };
  ...
  it('[Small] CreateUserCodec accepts valid email formats', () => {
    const validEmails = [
      'test@example.com',
  ...
  it('[Small] CreateUserCodec accepts various name formats', () => {
    const validNames = [
      'John Doe',
      'User123',
  ...
  it('[Small] CreateUserCodec rejects missing email', () => {
    const invalidUser = {
      name: 'Valid Name',
    } as any;
  ...
  it('[Small] CreateUserCodec handles edge case email formats', () => {
  ...
  it('[Small] UpdateUserCodec accepts partial user data', () => {
  ...
  it('[Small] UpdateUserCodec validates individual fields when provided', () => {
    const validUpdates = [
      { name: 'Valid Name' },
